  ...
  try {
    ...
    const mapped = visibleOrders.map((o) => {
      ...
      return {
        ...
        shiprocketBalanceBefore: Number.isFinite(Number(o.shiprocketBalanceBefore)) ? Number(o.shiprocketBalanceBefore) : null,
        shiprocketBalanceAfter: Number.isFinite(Number(o.shiprocketBalanceAfter)) ? Number(o.shiprocketBalanceAfter) : null,
...
router.get("/orders/:orderId", async (req, res) => {
  try {
    ...
    const mapped = {
      ...
      shiprocketBalanceBefore: Number.isFinite(Number(order.shiprocketBalanceBefore)) ? Number(order.shiprocketBalanceBefore) : null,
      shiprocketBalanceAfter: Number.isFinite(Number(order.shiprocketBalanceAfter)) ? Number(order.shiprocketBalanceAfter) : null,
